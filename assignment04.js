...
io.sockets.on("connection", function(socket) {
    socket.on("commandToArduino", function(commandNo){
        ...
        if (commandNo == "5") {
         ...
         if (commandNo == "6") {
            board.digitalWrite(11, board.LOW); // write LOW on pin 8
        }
        if (commandNo == "7") {
            board.digitalWrite(11, board.HIGH); // write HIGH on pin 8
        } 
            if (commandNo == "8") {
            board.digitalWrite(11, board.LOW); // write LOW on pin 8
            board.digitalWrite(12, board.LOW); // write LOW on pin 8
    ...
    timer5 = setInterval(function () {board.digitalWrite(12, board.HIGH);}, 50);
    timer6 = setInterval(function () {board.digitalWrite(12, board.LOW);}, 150);
    timer7 = setInterval(function () {board.digitalWrite(11, board.HIGH);}, 800);
    timer8 = setInterval(function () {board.digitalWrite(11, board.LOW);}, 950);
